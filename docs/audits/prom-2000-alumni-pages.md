...
Galindo Olarte Andres David is different: the page is a Microsoft Word HTML export with typed text over `FONDO_PLANETA.jpg`, plus a student photo and a divider GIF. This should be reviewed with the user before recreating the text-heavy layout.
